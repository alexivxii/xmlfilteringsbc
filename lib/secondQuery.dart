...
class secondQuery extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _State();
}

class _State extends State<secondQuery> {
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text("Modelele in functie de combustibil (electric/diesel)",
                                ...
                                for(int i=0;i<ListParentCompany.length;i++)
                                {
                                      ...
                                      for(int j=0;j<ListCompaniesInside.length;j++)
                                      {
                                        ...
                                        for(int k=0;k<ListCompaniesInside[j]['car'].length;k++)
                                          {
                                            if(ListCompaniesInside[j]['car'][k]["fuel"]==combustibilController.text)
