...
class _State extends State<FirstQuery> {
...
''';
                                ...
                                {
                                    if(ListParentCompany[i]["name"]==CompanyNameController.text){
                                      ...
                                      for(int j=0;j<ListCompaniesInside.length;j++)
                                      {
                                        ...
                                        List Cars=ListCompaniesInside[j]['car'];
                                        for(int k=0;k<ListCompaniesInside[j]['car'].length;k++)
                                          {
                                            //print(ListCompaniesInside[j]['car'][k]["model"]);
