...
class fifthQuery extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _State();
}

class _State extends State<fifthQuery> {
  ...
  TextEditingController combustibilController = TextEditingController();
                        ...
                        Container(
                          ...
                          child: Theme(
                            ...
                            child: TextField(
                              style: TextStyle(color: Colors.black54),
                              cursorColor: Colors.grey,
                              controller: combustibilController,
                              decoration: InputDecoration(
                                contentPadding: EdgeInsets.only(left: 10),
                                focusedBorder: const OutlineInputBorder(
                                  borderSide:
...
''';
                                ...
                                for(int i=0;i<ListParentCompany.length;i++)
                                {
                                  ...
                                  for(int j=0;j<ListCompaniesInside.length;j++)
                                  {
                                    ...
                                    {
                                      if(int.parse(ListCompaniesInside[j]['car'][k]["price"])<=int.parse(pretController.text) && ListCompaniesInside[j]['car'][k]["fuel"]==combustibilController.text)
